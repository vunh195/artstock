...
export const SUPPORTED_NETWORKS_ARRAY = [
  {
    chainId: '0x1',
  ...
  },
  {
    ...
    path: '/polygon.svg',
    rpcUrls: ['https://zksync2-testnet.zksync.dev/'], // ['https://matic-mainnet.chainstacklabs.com/'],
